...
$idDaPagina = $_GET['id'];
$pages = listingId('pages', $idDaPagina);
?>
<div class="col-md-9">
    <div class="box">
        ...
        <div class=" box-table">
            <form name="form" method="post" action="">
                ...
                <div class="form-group">
                    <label>Titulo</label>
                    <input type="text" class="form-control" name="titulo" value="<?php echo $pages['content_title'] ;?>">
                </div>
                <div class="form-group">
                    <label>Conteúdo</label>
                    <textarea type="text" class="form-control" name="editor1" value="<?php echo $pages['content_main'] ;?>" placeholder="<?php echo $pages['content_main'] ;?>"></textarea>
                </div>
