...
//
//if($id != NULL){
//    $stmt = $connection->prepare("SELECT * FROM produtos WHERE id = :id ");
...
//        switch($_POST['action']){
//            case 'update':
//                $stmt = $connection->prepare("UPDATE produtos SET nome = :nome, descricao = :descricao WHERE id = :id ");
...
//        }
//    } else {
//        $stmt = $connection->prepare("INSERT INTO produtos (nome, descricao) VALUES (:nome, :descricao)");
//        $stmt->bindValue('nome', $nome, PDO::PARAM_STR);
//        $stmt->bindValue('descricao', $descricao, PDO::PARAM_STR);
//        try{
//            $stmt->execute();
...
//$stmt = $connection->prepare("SELECT * FROM produtos ORDER BY id DESC");
//$stmt->execute();
